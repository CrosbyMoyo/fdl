...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.gold_catalog}.fin_controlling.dim_cost_element_hierarchy
    (
        cost_element_hierarchy_skey BIGINT
            CONSTRAINT dim_cost_element_hierarchy_pk PRIMARY KEY
