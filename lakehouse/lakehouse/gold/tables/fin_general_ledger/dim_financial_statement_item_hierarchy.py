...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.gold_catalog}.fin_general_ledger.dim_financial_statement_item_hierarchy
    (
        -- Keys
        financial_statement_item_skey BIGINT
            COMMENT "The SKEY for Financial Statment Item", 
        hierarchy_id STRING
            COMMENT "Hierarchy ID",
        hierarchy_name STRING
            COMMENT "Hierarchy Name",
        financial_statement_item_hierarchy_node STRING
        ...
        financial_statement_item_description STRING
            COMMENT "The description of the financial_statement_item",
        -- Payload
    ...
    CONSTRAINT pk_dim_financial_statement_item PRIMARY KEY (financial_statement_item_skey)
        )
        CLUSTER BY 
            AUTO;
''')