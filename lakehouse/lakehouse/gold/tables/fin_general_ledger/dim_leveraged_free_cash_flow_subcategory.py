...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.gold_catalog}.fin_general_ledger.dim_leveraged_free_cash_flow_subcategory (
        -- Keys
        leveraged_free_cash_flow_subcategory_skey BIGINT
