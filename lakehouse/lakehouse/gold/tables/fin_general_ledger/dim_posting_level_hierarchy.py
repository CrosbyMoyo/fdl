...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.gold_catalog}.fin_general_ledger.dim_posting_level_hierarchy
    (
        -- Keys
        ...
        posting_level_hierarchy_node STRING
        ...
        -- Payload
        posting_level_description STRING
            COMMENT "The description of the consolidation unit",
        ...
        CONSTRAINT pk_dim_posting_level PRIMARY KEY (posting_level_skey)
        )
        CLUSTER BY 
            AUTO;
''')