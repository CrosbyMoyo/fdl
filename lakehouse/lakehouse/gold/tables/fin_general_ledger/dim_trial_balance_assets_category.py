...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.gold_catalog}.fin_general_ledger.dim_trial_balance_assets_category (
        -- Keys
        trial_balance_assets_category_skey BIGINT
        ...
        tb_category_node STRING
            COMMENT 'Trial Balance Assets Category Hierarchy Node',

        -- Payload
        tb_category STRING
            COMMENT 'Trial Balance Assets Category',
