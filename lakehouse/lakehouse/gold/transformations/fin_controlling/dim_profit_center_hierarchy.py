...
dest_tablename = f'{env_vars.gold_catalog}.fin_controlling.dim_profit_center_hierarchy'
...
spark.sql(
    f'''
        SELECT 
            p.*
        from 
            {env_vars.silver_catalog}.fin_controlling.profit_center_hierarchy AS p
    '''
...
merge_result = spark.sql(f'''
    ...
    USING hashed AS src
        ...
        tgt.profit_center_hierarchy_node = src.profit_center_hierarchy_node AND
    ...
    WHEN NOT MATCHED THEN
        INSERT (
            ...
            src.hierarchy_id,
            src.profit_center_hierarchy_node,
