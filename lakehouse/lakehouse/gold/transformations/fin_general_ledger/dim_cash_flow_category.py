...
dbutils.widgets.text(
    ...
    defaultValue='gold.dim.cash_flow_category.yaml',
...
cfcat_tablename = metadata.source_3partname(
    tablename='cash_flow_category',
...
gold_table_query = f'''
    SELECT
        cfcat.rank,
        cfcat.parent_id,
        cfcat.cf_category_node,
        cfcat.cf_category
    FROM
        {cfcat_tablename} AS cfcat
'''
