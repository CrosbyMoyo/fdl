...
dbutils.widgets.text(
    ...
    defaultValue='gold.dim.cash_flow_subcategory.yaml',
...
cfsubcat_tablename = metadata.source_3partname(
    tablename='cash_flow_subcategory',
...
gold_table_query = f'''
    SELECT
        cfsubcat.category_rank,
        cfsubcat.node,
        cfsubcat.category_id,
        cfsubcat.sub_category_description,
        cfsubcat.category_description
    FROM
        {cfsubcat_tablename} AS cfsubcat
'''
