...
dbutils.widgets.text(
    ...
    defaultValue='gold.dim.consolidation_reporting_item_hierarchy.yaml',
...
consolidation_reporting_item_hierarchy_tablename = metadata.source_3partname(
    tablename='consolidation_reporting_item_hierarchy',
...
gold_table_query = (
    f'''
        SELECT 
            fsi.hierarchy_id,
            fsi.hierarchy_name,
            fsi.reporting_item_hierarchy_node,
            fsi.reporting_item_description,
            fsi.hierarchy_level,
            fsi.is_leaf_node,
            fsi.level_1_node,
        ...
        FROM 
            {consolidation_reporting_item_hierarchy_tablename} AS fsi
    '''
)
