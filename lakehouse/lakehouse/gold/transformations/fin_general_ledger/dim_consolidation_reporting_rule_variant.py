...
dbutils.widgets.text(
    ...
    defaultValue='gold.dim.consolidation_reporting_rule_variant.yaml',
...
consolidation_reporting_rule_variant_tablename = metadata.source_3partname(
    tablename='consolidation_reporting_rule_variant',
...
gold_table_query = f'''
    SELECT 
        cri.reporting_rule_variant,
        cri.reporting_item_hierarchy,
        cri.consolidation_chart_of_accounts,
        cri.description
    FROM 
        {consolidation_reporting_rule_variant_tablename} AS cri
'''
