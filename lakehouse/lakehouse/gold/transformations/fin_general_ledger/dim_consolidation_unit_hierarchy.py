...
dbutils.widgets.text(
    ...
    defaultValue='gold.dim.consolidation_unit_hierarchy.yaml',
...
consolidation_unit_hierarchy_tablename = metadata.source_3partname(
    tablename='consolidation_unit_hierarchy',
...
gold_table_query = (
    f'''
        SELECT 
            fsi.hierarchy_id,
            fsi.hierarchy_name,
            fsi.consolidation_unit_hierarchy_node,
            fsi.consolidation_unit_description,
            fsi.hierarchy_level,
            fsi.is_leaf_node,
            fsi.level_1_node,
        ...
        FROM 
            {consolidation_unit_hierarchy_tablename} AS fsi
    '''
)
