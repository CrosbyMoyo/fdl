...
dbutils.widgets.text(
    ...
    defaultValue='gold.dim.financial_statement_version_hierarchy.yaml',
...
financial_statement_version_hierarchy_tablename = metadata.source_3partname(
    tablename='financial_statement_version_hierarchy',
...
gold_table_query = (
    f'''
        ...
        FROM 
            {financial_statement_version_hierarchy_tablename} AS fsi
    '''
)
