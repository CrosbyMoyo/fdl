...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.ca_cross_application_components.countries (

        client STRING
            COMMENT "Client",
        country_key STRING
            COMMENT "Country/Region Key",
        language_key STRING
            COMMENT "Language Key",
        standard_name_format STRING
            COMMENT "Standard name format",
        iso_code STRING
            COMMENT "ISO Code",
        iso_code_3_characters STRING
            COMMENT "ISO Code 3 Characters",
        iso_code_numeric_3chars INT
            COMMENT "ISO Code Numeric 3-Chars",
        is_eu_member STRING
            COMMENT "EU Member",
        nationality STRING
            COMMENT "Nationality",
        ...
        COMMENT "Master table of Countries"
        CLUSTER BY
            AUTO;
''')