...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.ca_cross_application_components.country_coordinates (
        ...
        COMMENT "Geo location data for various countries and regions. It includes the longitude, latitude, and altitude of each location."
        CLUSTER BY
            AUTO;
''')