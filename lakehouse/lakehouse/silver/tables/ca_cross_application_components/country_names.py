...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.ca_cross_application_components.country_names (
        ...
        nationality_short STRING
            COMMENT "15 character nationality",
        country_name_full STRING
            COMMENT "Full country name",
        nationality_full STRING
            COMMENT "Full nationality",
        ...
        COMMENT "English names for Countries"
        CLUSTER BY
            AUTO;
''')