...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_controlling.profit_center_substitution (
        profit_center STRING 
            COMMENT 'Defines the profit center for financial reporting',
        division STRING 
            COMMENT 'Represents the division for the profit center',
        sales_division_description STRING
            COMMENT 'Description of the division',
        ...
        distribution_channel STRING 
            COMMENT 'Channel through which sales are conducted',
        distribution_channel_description STRING
            COMMENT 'Description of the distribution channel',
