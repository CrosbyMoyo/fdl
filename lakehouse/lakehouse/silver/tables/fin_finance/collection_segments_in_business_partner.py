...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_finance.collection_segments_in_business_partner (
        -- Keys 
        client STRING COMMENT 'Client' ,
        collection_segment STRING COMMENT 'Collection Segment',
        business_partner STRING COMMENT 'Business Partner',
        created_on DATE COMMENT 'Created on Date',

        -- Measures
        closed_on DATE COMMENT 'Closed on Date',
        main_contact_person STRING COMMENT 'Main Contact Person',
        collection_specialist STRING COMMENT 'Collection Specialist',
        collection_group STRING COMMENT 'Collection Group',
