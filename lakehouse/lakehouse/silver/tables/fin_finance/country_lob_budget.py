...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_finance.country_lob_budget (
        -- KEY
        country_lob_budget_id INT
        ...
        line_of_business_id STRING
            COMMENT 'line of business id', 
        model_subtype_id INT
            COMMENT 'model subtype id',
        budget_year INT
            COMMENT 'budget year',
        budget DECIMAL(18,4)
