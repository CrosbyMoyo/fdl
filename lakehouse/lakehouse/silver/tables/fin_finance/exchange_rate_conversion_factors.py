...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_finance.exchange_rate_conversion_factors (
        -- Key
        valid_from DATE
        ...
        -- Payload
        ratio_from INTEGER
            COMMENT 'Ratio for the from currency units',
        ratio_to INTEGER
            COMMENT 'Ratio for the to currency units',
