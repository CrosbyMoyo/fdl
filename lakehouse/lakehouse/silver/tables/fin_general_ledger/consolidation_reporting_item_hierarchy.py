...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.consolidation_reporting_item_hierarchy (
        -- Keys 
        hierarchy_id STRING
        ...
        reporting_item_hierarchy_node STRING
            COMMENT "The financial statement item hierarchy node ID. This is the node ID at the root of the hierarchy",
        -- Payload
