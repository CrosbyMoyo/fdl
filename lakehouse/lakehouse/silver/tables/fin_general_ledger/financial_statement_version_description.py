...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.financial_statement_version_description (
        -- key
        client STRING
        ...
        -- payload
        financial_statement_version_description STRING
            COMMENT 'Description of the financial statement version',
