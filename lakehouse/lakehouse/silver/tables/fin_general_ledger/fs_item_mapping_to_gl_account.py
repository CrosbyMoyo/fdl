...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.fs_item_mapping_to_gl_account (
        --key
        client STRING
            COMMENT 'client',
        consolidation_coa STRING
            COMMENT 'consolidation chart of accounts',
        chart_of_accounts STRING
            COMMENT 'chart of accounts',
        fs_item_mapping_id STRING
            COMMENT 'financial statement item mapping id',
        fs_item_mapping_revision STRING
            COMMENT 'financial statement item mapping revision',
        ...
        first_gl_account STRING
            COMMENT 'First GL Account when a GL Account is not found in the SGR data',
