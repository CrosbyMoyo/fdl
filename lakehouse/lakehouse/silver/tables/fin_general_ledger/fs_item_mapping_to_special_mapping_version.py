...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.fs_item_mapping_to_special_mapping_version (
        --key
        client STRING
            COMMENT 'client',
        ...
        valid_from DATE
            COMMENT 'valid from',
        valid_to_fiscal_yearperiod INT
            COMMENT 'valid to fiscal year period',
        valid_from_fiscal_yearperiod INT
            COMMENT 'valid from fiscal year period',
        fs_item_mapping_id STRING
            COMMENT 'fs item mapping id',
        fs_item_mapping_revision STRING
            COMMENT 'fs item mapping revision',
