...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.leveraged_free_cash_flow_subcategory (
        -- Keys
        category_rank INT 
            COMMENT "Cash Flow Category Rank",
        node STRING 
        ...
        category_description STRING 
            COMMENT "Cash Flow Category Description",
