...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.posting_level_hierarchy (
        -- Keys 
        hierarchy_id STRING
        ...
        posting_level_hierarchy_node STRING
            COMMENT "The posting level node ID. This is the node ID at the root of the hierarchy",
        level_1_node STRING
