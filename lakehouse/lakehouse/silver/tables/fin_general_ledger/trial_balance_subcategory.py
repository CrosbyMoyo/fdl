...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.trial_balance_subcategory (
        -- Keys
        category_rank INT 
            COMMENT "Trial Balance Category Rank",
        node STRING 
            COMMENT "Hierarchy Node",
        category_id STRING 
            COMMENT "Trial Balance Category Node",

            
        -- Payload
        sub_category_description STRING 
            COMMENT "Sub Category Description",
        category_description STRING 
            COMMENT "Trial Balance Category Description",
