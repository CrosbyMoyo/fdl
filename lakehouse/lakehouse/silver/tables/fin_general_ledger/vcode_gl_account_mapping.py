...
spark.sql(f'''
    CREATE OR REPLACE TABLE {env_vars.silver_catalog}.fin_general_ledger.vcode_gl_account_mapping (
        ...
        vcode STRING
            COMMENT 'V Code',
        vcode_join_field STRING
            COMMENT 'V Code Join Field derived using CONCAT(CONCAT(gl_account, _),cost_center_category)',
