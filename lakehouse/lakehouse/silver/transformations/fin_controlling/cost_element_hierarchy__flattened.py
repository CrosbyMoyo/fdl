...
metadata_filename = "silver.cska.yaml"
...
flattened_cost_element = hierarchy_flattener.sap_s4hana_hierarchy_flattener(setheader, setnode, setleaf, setclst, setclass="0102", hier_id=None)

# COMMAND ----------

flattened_cost_element.write.mode("overwrite").option("overwriteSchema", "true").saveAsTable(dest_tablename)
