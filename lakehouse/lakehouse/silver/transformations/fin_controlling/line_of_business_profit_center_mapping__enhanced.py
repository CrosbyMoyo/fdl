...
metadata_filename = "silver.1pc_lobprofctr.yaml"
...
casted_tablename = f'{env_vars.silver_catalog}.{metadata.destination_2partname("casted", include_schemaversion=True)}'
