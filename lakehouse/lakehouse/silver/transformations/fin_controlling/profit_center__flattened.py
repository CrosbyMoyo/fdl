...
metadata_filename = "silver.cepc.yaml"
...
flattened_profit_centers = hierarchy_flattener.sap_s4hana_hierarchy_flattener(setheader, setnode, setleaf, setclst, setclass="0106", hier_id=None)
