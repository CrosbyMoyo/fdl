...
metadata_filename = "silver.consolidation_reporting_item_hierarchy.yaml"
...
spark.sql(
    f"""
        SELECT
             s.hierarchy_id
             ,s.hierarchy_name
            ,s.node_id                AS reporting_item_hierarchy_node
            ,s.description            AS reporting_item_description
