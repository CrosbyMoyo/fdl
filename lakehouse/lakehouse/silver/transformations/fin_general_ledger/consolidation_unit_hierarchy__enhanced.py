...
metadata_filename = "silver.consolidation_unit_hierarchy.yaml"
...
spark.sql(
    f"""
        SELECT
             s.hierarchy_id
            ,s.hierarchy_name
            ,s.node_id                AS consolidation_unit_hierarchy_node
            ,s.description            AS consolidation_unit_description
