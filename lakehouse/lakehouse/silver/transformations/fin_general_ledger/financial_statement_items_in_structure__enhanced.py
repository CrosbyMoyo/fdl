...
# MAGIC %md
# MAGIC ## fagl_011pc Bronze to Silver
# MAGIC
# MAGIC Generic Notebook moves the `{bronze}.fivetran_s4p.fagl_011pc` data to a staging table defined in the metadata.
# MAGIC
# MAGIC This notebook further refines that data, and adds the payload fingerprint.  Then merges the data into `{silver}.fin_general_ledger.financial_statement_items_in_structure` table.
...
metadata_filename = "silver.fagl_011pc.yaml"
