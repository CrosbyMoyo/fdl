...
# MAGIC %md
# MAGIC ## 1pc_sgrconsitem Bronze to Silver
# MAGIC
# MAGIC Generic Notebook moves the `{bronze}.fivetran_s4p.1pc_sgrconsitem` data to a staging table defined in the metadata.
# MAGIC
# MAGIC This notebook further refines that data, and adds the payload fingerprint.  Then merges the data into `{silver}.fin_controlling.sgr_cons_item` table.
...
metadata_filename = "silver.1pc_sgrconsitem.yaml"
