...
metadata_filename = "silver.vcodes_hierarchy.yaml"
...
spark.sql(
    f"""
        SELECT
             s.hierarchy_id
            ,s.hierarchy_name
            ,s.node_id                AS vcode_hierarchy_node
            ,s.description            AS vcode_description
            ...
            ,s.level_9_node_text                        
            ,s.level_10_node                
            ,s.level_10_node_text           
            ,s.level_11_node                
            ,s.level_11_node_text           
            ,s.level_12_node                
            ,s.level_12_node_text           
            ,s.level_13_node                
            ,s.level_13_node_text           
            ,s.level_14_node                
            ,s.level_14_node_text           
            ,s.__etl_keys_fprint
