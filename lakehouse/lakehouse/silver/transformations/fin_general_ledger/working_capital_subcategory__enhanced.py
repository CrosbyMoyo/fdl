...
metadata_filename = "silver.working_capital_subcategory.yaml"
...
working_capital_category_tablename = f'{env_vars.silver_catalog}.{metadata.sources_2partname("working_capital_category")}'
...
enhanced = spark.sql(f'''
    SELECT
        ...
        c.wc_category AS category_description,
        c.rank AS category_rank
    FROM
        base AS b
        JOIN {working_capital_category_tablename} AS c
