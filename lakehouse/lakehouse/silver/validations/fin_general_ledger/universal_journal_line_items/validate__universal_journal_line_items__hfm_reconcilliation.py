...
# MAGIC %md
# MAGIC ## Validate: Universal Journal Line Items HFM Datasphere Reconcilliation
# MAGIC #### Purpose:
...
# MAGIC - Only compares HFM records
  ...
  f'''
    WITH datasphere AS (
      ...
      WHERE 1=1
        ...
        AND datasource LIKE '%HFM%'
        AND Reporting_QuantityL20 <> 0
      GROUP BY ALL
    )
